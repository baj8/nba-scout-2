...
from nba_scraper.transformers.games_bridge import _normalize_game_status, to_db_game
from nba_scraper.utils.season import derive_season_from_date, derive_season_from_game_id
from nba_scraper.utils.team_lookup import get_team_index  # Use the mockable version
...
class TestGamesBridge:
    ...
    def test_status_casing_normalized(self):
        ...
        # Provide explicit team index instead of calling get_team_index()
    ...
    def test_unknown_tricode_raises_targeted_error(self):
        ...
        with pytest.raises(ValueError, match="Unknown tricode 'INVALID' for game 0022400001"):
    ...
    def test_season_fallback_strategies(self, mock_get_index, mock_load):
        ...
        # Test fallback to game ID derivation - use a season that will trigger derivation
        game_row = GameRow(
            game_id="0022300456",
            season="1900-01",  # Invalid season that will trigger derivation
